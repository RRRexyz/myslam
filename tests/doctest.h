...
struct DOCTEST_INTERFACE ExpressionDecomposer {
    ...
    operator<<(const L &&operand) { // bitfields bind to universal ref but not
                                    // const rvalue ref
    ...
    if (rb.m_at &
        ...
        s << Color::Cyan << assertString(rb.m_at) << "( " << rb.m_expr << ", "
          ...
          << Color::Cyan << rb.m_exception << "\n";
               ...
               assertType::is_throws_with) { //! OCLINT bitwise operator in
                                             //! conditional
        s << Color::Cyan << assertString(rb.m_at) << "( " << rb.m_expr << ", \""
          ...
          << (rb.m_threw ? (!rb.m_failed ? "threw as expected!"
                         ...
                         : "did NOT throw at all!")
          << Color::Cyan << rb.m_exception << "\n";
    } else if (rb.m_at & assertType::is_nothrow) { //! OCLINT bitwise operator
                                                   //! in conditional
...
struct ConsoleReporter : public IReporter {
    ...
    void
    successOrFailColoredStringToStream(bool success, assertType::Enum at,
